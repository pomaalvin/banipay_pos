...
class TigoMoneyPage extends StatelessWidget {
  ...
  final tigo=Get.put<TigoController>(TigoController());
  TigoMoneyPage({Key? key,required this.amountNumber}) : super(key: key);
